                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div
                                    ...
                                    <div class="testimonial__thumbnail--style2">
                                        <img class="testimonial__items--thumbnail__img display-block"
                                            src="{{ asset('ggm/assets/img/other/testimonial-thumb1.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__content--style2">
                                        <h3 class="testimonial__items--author__title h4">Abdur Razzak</h3>
                                        <h4 class="testimonial__items--author__subtitle h5">Ui Ux Designer
                                        </h4>
                                        <p class="testimonial__items--desc style2"><svg
                                            ...
                                            accusan tium doloremque. <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="testimonial__thumbnail--style2">
                                        <img class="testimonial__items--thumbnail__img display-block"
                                            src="{{ asset('ggm/assets/img/other/testimonial-thumb2.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__content--style2">
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="testimonial__thumbnail--style2">
                                        <img class="testimonial__items--thumbnail__img display-block"
                                            src="{{ asset('ggm/assets/img/other/testimonial-thumb3.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__content--style2">
                                        <h3 class="testimonial__items--author__title h4">Sohidul Alam</h3>
                                        <h4 class="testimonial__items--author__subtitle h5">CEO Peque Theme
                                        </h4>
                                        <p class="testimonial__items--desc style2"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="8.101" height="6.481"
                                                viewBox="0 0 8.101 6.481">
