                    ...
                    <div class="blog__items">
                        <div class="blog__thumbnail">
                            <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                    ...
                                    src="{{ asset('ggm/assets/img/blog/blog1.webp') }}" alt="blog-img"></a>
                        </div>
                        <div class="blog__content">
                            ...
                            <h3 class="blog__content--title h4"><a href="blog-details.html">Top 10 Best
                                    Furniture Company
                ...
                <div class="swiper-slide">
                    <div class="blog__items">
                        <div class="blog__thumbnail">
                            <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                    class="blog__thumbnail--img display-block"
                                    src="{{ asset('ggm/assets/img/blog/blog2.webp') }}" alt="blog-img"></a>
                        </div>
                        <div class="blog__content">
                            <ul class="blog__content--meta d-flex">
                                <li class="blog__content--meta__text">
                            ...
                            <h3 class="blog__content--title h4"><a href="blog-details.html">Lorem, ipsum
                                    dolor sit amet are consectetur adipisicing elit.</a></h3>
                            <p class="blog__content--desc">Mum ut perspiciatis unde omnis iste
                                natus error sit voluptatem…..</p>
                            <a class="blog__content--btn primary__btn" href="blog-details.html">Read more
                            </a>
                ...
                <div class="swiper-slide">
                    <div class="blog__items">
                        <div class="blog__thumbnail">
                            <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                    class="blog__thumbnail--img display-block"
                                    src="{{ asset('ggm/assets/img/blog/blog3.webp') }}" alt="blog-img"></a>
                        </div>
                        <div class="blog__content">
                            <ul class="blog__content--meta d-flex">
                                <li class="blog__content--meta__text">
                            ...
                            <h3 class="blog__content--title h4"><a href="blog-details.html">Amet
                                    consectetur adipisicing elit. Commodi placeat iure there are.</a></h3>
                            <p class="blog__content--desc">Mum ut perspiciatis unde omnis iste
                                natus error sit voluptatem…..</p>
                            <a class="blog__content--btn primary__btn" href="blog-details.html">Read more
                            </a>
                ...
                <div class="swiper-slide">
                    <div class="blog__items">
                        <div class="blog__thumbnail">
                            <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                    class="blog__thumbnail--img display-block"
                                    src="{{ asset('ggm/assets/img/blog/blog4.webp') }}" alt="blog-img"></a>
                        </div>
                        <div class="blog__content">
                            <ul class="blog__content--meta d-flex">
                                <li class="blog__content--meta__text">
