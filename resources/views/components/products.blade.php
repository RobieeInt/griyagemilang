                                ...
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('ggm/assets/img/product/product2.webp') }}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('ggm/assets/img/product/product1.webp') }}" alt="product-img">
                                    </a>
                                        ...
                                        <li class="rating__list">
                                            <span class="rating__list--icon">
                                                <svg class="rating__list--icon__svg"
                                                    xmlns="http://www.w3.org/2000/svg" width="11.105" height="11.732"
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                ...
                                <div class="product__items--content text-center">
                                    ...
                                    <a class="product__items--content__tag" href="product-details.html">Chair</a>
                                    <h3 class="product__items--content__title h4"><a href="product-details.html">Globe
                                            Electric Lamp</a></h3>
                                    <div class="product__items--price">
